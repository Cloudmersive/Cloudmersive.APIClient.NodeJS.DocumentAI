# cloudmersive-documentaiapi-client

CloudmersiveDocumentaiapiClient - JavaScript client for cloudmersive-documentaiapi-client
...
```shell
npm install cloudmersive-documentaiapi-client --save
```
...
Finally, switch to the directory you want to use your cloudmersive-documentaiapi-client from, and run:

```shell
npm link /path/to/<JAVASCRIPT_CLIENT_DIR>
```

You should now be able to `require('cloudmersive-documentaiapi-client')` in javascript files from the directory you ran the last 
command above from.

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveDocumentaiapiClient.AnalyzeApi();
  });
  ...
  describe('AnalyzeApi', function() {
    describe('applyRules', function() {
      it('should call applyRules successfully', function(done) {
        //uncomment below and update the code to test applyRules
        //instance.applyRules(function(error) {

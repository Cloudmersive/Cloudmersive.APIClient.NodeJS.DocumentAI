...
(function(root, factory) {
  ...
  /**
   * Constructs a new <code>ExtractFieldsResponse</code>.
   * Result of extracting fields from a document
   * @alias module:model/ExtractFieldsResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>ExtractFieldsResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ExtractFieldsResponse} obj Optional instance to populate.
   * @return {module:model/ExtractFieldsResponse} The populated <code>ExtractFieldsResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('Results')) {
        obj['Results'] = ApiClient.convertToType(data['Results'], [FieldValue]);
      }
    }
    return obj;
  }
   ...
   * @member {Array.<module:model/FieldValue>} Results
   */
